package com.epds.dev.iimsuiremake.buttonbasedchatbot.chatadapter;
...
import com.epds.dev.iimsuiremake.ChatBotFragment;
import com.epds.dev.iimsuiremake.R;
import com.epds.dev.iimsuiremake.buttonbasedchatbot.dataclass.ChatItem;
import com.epds.dev.iimsuiremake.buttonbasedchatbot.viewholder.BotViewHolder;
import com.epds.dev.iimsuiremake.buttonbasedchatbot.viewholder.DateTimeViewHolder;
import com.epds.dev.iimsuiremake.buttonbasedchatbot.viewholder.FormViewHolder;
import com.epds.dev.iimsuiremake.buttonbasedchatbot.viewholder.MainViewHolder;
import com.epds.dev.iimsuiremake.buttonbasedchatbot.viewholder.OptionsViewHolder;
import com.epds.dev.iimsuiremake.buttonbasedchatbot.viewholder.UserViewHolder;
...
public class ChatAdapter extends RecyclerView.Adapter<MainViewHolder> {
    ...
    public ChatAdapter(Context context, RecyclerView recyclerView,
                       ChatBotFragment listener, ChatBotFragment cancelListener,
                       List<ChatItem> chatItems,
                       OnItemClickListener confirmListener) {
    ...
    public int getItemViewType(int position) {
        if (items.get(position) instanceof ChatItem.User) {
            ...
            return TYPE_FORM;
        } else if (items.get(position) instanceof ChatItem.DateTime) {
    ...
    public MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        } else if (viewType == TYPE_DATETIME) {
            View view = inflater.inflate(R.layout.date_time, parent, false);
    ...
    public void onBindViewHolder(@NonNull MainViewHolder holder, int position) {
        if (holder instanceof UserViewHolder) {
            ...
            ChatItem.DateTime dateTime = (ChatItem.DateTime) items.get(position);
            ((DateTimeViewHolder) holder).dateTime.setText(dateTime.dateTime);
